...
% 16.323 - HW #1
%-------------------------------------------------------------------------------
% This script defines the function handles for the different minimization
% problems and contains the desired starting point. The BFGS solver bfgs.m is
% called by passing it a function handle and initial guess. The state history,
% number of iterations, and number of function calls are returned and plotted.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
