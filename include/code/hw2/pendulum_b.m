...
% 16.323 - HW #2
%-------------------------------------------------------------------------------
% Pendulum dynamics forward code and adjoint method reverse code. This function
% takes as an input the vector u - control input for the entire time interval.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [cost, ub, x] = pendulum_b(u)
    ...
    % This code uses RK4 to integrate forward the state x in time, as well as
    % the cost at each moment in time.
    for ii=1:n-1;
        k11 = dt*x2(ii);
